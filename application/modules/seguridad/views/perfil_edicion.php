<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"><span id="modal_edicion_master">Perfil</span></h5>
...
<div class="modal-body">
    ...
    ?>
    <?= form_open(base_url() . "seguridad/perfil/perfil_guardar", array("id" => "form_modal_edicion")); ?>
...
<div class="modal-footer">
    ...
    <script>
        ...
        function recargarPerfil() {
            loadPerfil(<?= isset($perfil->id) ? $perfil->id : 0 ?>);
        }
