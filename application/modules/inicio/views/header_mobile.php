                            ...
                            <ul class="ps-list--categories">
                                ...
                                ?>
                                    <li class="current-menu-item menu-item-has-children">
                                        ...
                                        <a href="<?php echo base_url() . $categoria['url_categoria'] ?>">
                                                ...
                                                <?php if ($categoria['subcategorias'][$id_cat]) { ?>
                                                    ...
                                                    ?>
                                                        <li class="current-menu-item ">
                                                            <a href="<?php echo base_url() . $subcategoria->url_subcategoria ?>"><?php echo $subcategoria->nombre_subcategoria ?></a>
                                                        </li>
                                                    <?php } ?>
                                                <?php } ?>
                                            <?php } ?>
                            ...
                            <div class="ps-cart__items">
                                ...
                                <div class="ps-product--cart-mobile">
                                    ...
                                    <div class="ps-product__content">
                                        ...
                                        <a class="ps-product__remove btn" onclick="removeSC('<?php echo $item->url_product ?>','<?php echo $_SERVER["REQUEST_URI"] ?>')">
    ...
    <div class="ps-search--mobile">
        ...
        <form class="ps-form--search-mobile">
            <div class="form-group--nest">
                ...
                <button type="button" class="btnSearch" path="<?php echo base_url() . "inicio/productos/" ?>"><i class="icon-magnifier"></i></button>
            </div>
        </form>
