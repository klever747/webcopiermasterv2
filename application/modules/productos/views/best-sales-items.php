<?php
$bestSalesItems = $categoriasMasVendidas;
?>
...
<div class="ps-block--shop-features preloadFalse">
    ...
    <div class="ps-block__header">
        ...
        <h3>Mejores Productos Vendidos</h3>
                    ...
                    <div class="ps-product">
                        ...
                        ======================================-->
                            ...
                            <ul class="ps-product__actions">
                                ...
                                <li>
                                    <a class="btn" data-toggle="tooltip" data-placement="top" title="Añadir al carito">
                                        <i class="icon-bag2"></i>
                                    </a>
                                </li>
