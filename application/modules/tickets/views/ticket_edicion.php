...
<div class="modal-body">
    ...
    if($resumen_ticket){
        $fields['resumen']['value'] = $resumen_ticket;
    }
    ...
    $fields['resumen']['tipo'] = 'textarea';
    $fields['estado']['tipo'] = 'select';

    if (key_exists('nombre', $fields)) {
        $fields['nombre']['tipo'] = 'hidden';
    ...
    ?>
    <?= form_open(base_url() . "tickets/ticket/ticket_guardar", array("id" => "form_modal_edicion")); ?>
