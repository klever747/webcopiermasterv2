<div class="modal-header">
    <h5 class="modal-title" id="exampleModalLabel"><span id="modal_edicion_master">Producto</span></h5>
...
<div class="modal-body">
    ...
    $fields['almacen_id']['tipo'] = 'select';
    $fields['almacen_id']['sel'] = $almacenes;
    $fields['estado']['tipo'] = 'select';
    $fields['estado']['sel'] = array(ESTADO_ACTIVO => 'Activo', ESTADO_INACTIVO => 'Inactivo');
    $fields['unidad_medida']['tipo'] = 'select';
    $fields['unidad_medida']['sel'] = array(KILOGRAMO => 'Kg', CAJAS => 'Cajas', RESMAS=>'Resmas');

    ?>
    <?= form_open(base_url() . "inventario/producto/producto_guardar", array("id" => "form_modal_edicion")); ?>
